...
下载步骤：
    ...
    5、 输入 命令   ：     
        git clone https://github.com/101238095/DST_Black_Book.git

    6、 等待下载完成。这个时候会多出个文件夹【DST_Black_Book】。这个就是MOD的所有东西。

    7、 进入【DST_Black_Book】文件夹，重新右键【Git Bash Here】
...
更新步骤：
    ...
    2、右键【DST_Black_Book】文件夹，重新右键【Git Bash Here】
