...
--[[
    ...
    避茄针（hook就行了 把寄生函数顶掉  这个不知道为啥不行  还是采用小穹的试一试吧）

]]--
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local assets =
{
    Asset("ANIM", "anim/t_b_b_building_avoidable_lunarthrall_plant_lightning_rod.zip"),
...
local function fn()
    ...
    inst:AddTag("t_b_b_building_avoidable_lunarthrall_plant_lightning_rod")
    inst:AddTag("lightningrod")
    -- inst:AddTag("lunarthrall_plant") --- 月奴植物


    inst.AnimState:SetBank("t_b_b_building_avoidable_lunarthrall_plant_lightning_rod")
    inst.AnimState:SetBuild("t_b_b_building_avoidable_lunarthrall_plant_lightning_rod")
...
return Prefab("t_b_b_building_avoidable_lunarthrall_plant_lightning_rod", fn, assets, prefabs),
    MakePlacer("t_b_b_building_avoidable_lunarthrall_plant_lightning_rod_placer", "t_b_b_building_avoidable_lunarthrall_plant_lightning_rod", "t_b_b_building_avoidable_lunarthrall_plant_lightning_rod", "idle")
